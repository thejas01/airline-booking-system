...
public class JwtHelper {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        // Add role to claims if userDetails is instance of User
        if (userDetails instanceof com.thejas.user_service.model.User) {
            com.thejas.user_service.model.User user = (com.thejas.user_service.model.User) userDetails;
